...
class _CameraExampleHomeState extends State<CameraExampleHome> {
  ...
  @override
  void dispose() {
    // Ensure to dispose of the controller when it's no longer needed
    controller.dispose();
    super.dispose();
  }
      ...
      body: FutureBuilder<void>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            // Display a loading indicator while the camera is being initialized
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          try {
            ...
            // Capture the picture and save it to the defined path
            await controller.takePicture();

            // Display or use the captured picture as needed
          } catch (e) {
            print(e);
          }
        },
